                      ...
                      <div class="flex flex-wrap">
                          ...
                          <div class="lg:w-6/12 mt-8">
                            <div class="api_code_with_copy_code">
                              ...
                              <div class="code">
<pre class="code-wrapper">
<code class="lang-js theme-dracula" v-pre>const { ethers } = require("ethers");
                      ...
                      <div class="flex flex-wrap">
                          ...
                          <div class="lg:w-6/12 mt-8">
                            <div class="api_code_with_copy_code">
                              ...
                              <div class="code">
<pre class="code-wrapper">
<code class="lang-js">import fs from 'fs';
...
export default {
  ...
  methods: {
    ...
    copyCode() {
      ...
      const codeElement = document.querySelector('.code-wrapper code');
